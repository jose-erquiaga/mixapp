...
- [x] 3.1 Listar canciones guardadas (nombre, BPM, duración, nº de bloques)
- [x] 3.2 Cargar una canción al workspace (decodificar + añadir Track)
- [x] 3.3 Hoja/modal a pantalla completa (móvil-first)

## 4. Re-vinculación de bloques
- [x] 4.1 Al cargar desde biblioteca, mergear los bloques guardados
